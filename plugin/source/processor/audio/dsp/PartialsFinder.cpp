...
partialsVec PartialsFinder::findPartials(juce::AudioBuffer<float> buffer) {
    ...
    */
    ...
    int startSample;
    switch (posFindStrat) {
    case PartialsFindPosStrat::midrangeRMS:
        startSample = findPosMidrangeRMS(buffer);
        break;
    case PartialsFindPosStrat::medianRMS:
        startSample = findPosMedianRMS(buffer);
        break;
    case PartialsFindPosStrat::minRMSfluct:
        startSample = findPosMinRMSfluct(buffer);
        break;
    case PartialsFindPosStrat::maxSpectralFlatness:
        startSample = findPosMaxSpectralFlatness(buffer);
        break;
    case PartialsFindPosStrat::peakSample:
...
void PartialsFinder::setPosFindStrat(PartialsFindPosStrat pfs) { posFindStrat = pfs; }
